...
model_H = "/home/aidl/openvino_models/intel/person-detection-retail-0013/FP16/person-detection-retail-0013"
model_P = "/home/aidl/openvino_models/intel/person-reidentification-retail-0200/FP16/person-reidentification-retail-0200"
...
def main():
    ...
    while cv2.waitKey(1)!=27:    
        ...
        try:
            ...
            object_H.append(data_base_h([0,0, 0,0], np.zeros(512)))
        ...
        for i in range(0,D_1.shape[0]):
            for j in range(i+1,D_1.shape[1]):
                print(abs(object_H[i].pos[1]-object_H[j].pos[1]))
                if  (D_1[i,j] != 0.0 and D_1[i,j]  < Social_parameter) and abs(object_H[i].pos[1]-object_H[j].pos[1]) < 10.0 :
        ...
        #image = cv2.resize(image,dsize=(1800,1080))
        image = cv2.resize(image,dsize=(int(1920*0.9),int(1080*0.9)))
